...
This doc gives an overview of the Amplitude Analytics concepts and resources you need to get started.
...
-   :material-book-open-variant:{ .lg .middle } __Learn the basics__
    ...
    Get familiar with the basics of Amplitude Analytics.

    [:octicons-arrow-right-24: Understand the basics](#understanding-amplitude-analytics)

-   :material-code-braces:{ .lg .middle } __Amplitude Analytics SDKs__

    ---

    Find the right Amplitude Analytics SDK for your app.

    [:octicons-arrow-right-24: See the SDKs](#amplitude-analytics-sdks)

-   :material-file-code-outline:{ .lg .middle } __Amplitude Analytics APIs__
