---
title: Send Amplitude User Profile Data to Movable Ink
description: Send Amplitude User Profile data to Movable Ink to automatically generate and target content based on Amplitude user data.
---
