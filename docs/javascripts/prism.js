...
/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+bash+c+csharp+cpp+dart+go+go-module+gradle+http+java+json+kotlin+markup-templating+php+powershell+python+jsx+tsx+regex+ruby+rust+shell-session+sql+typescript+unrealscript+vim+xml-doc+yaml&plugins=command-line */
