---
title: Android Kotlin SDK (Beta)
description: Official documentation for the Amplitude Analytics Android Kotlin SDK.
...
This is the official documentation for the Amplitude Kotlin Android SDK.
...
This library is open-source, check it out on [GitHub](https://github.com/amplitude/Amplitude-Kotlin).
