...
This reference covers examples and operators for the Amazon S3 Import and GCS converter configuration. See the [S3 guide](./sources/amazon-s3.md) or the [GCS guide](./sources/google-cloud-storage.md) for more information.
