...
!!!deprecated Legacy
    This is a legacy GTM template. For the most up-to-date implementation. It's recommended to use the [latest template](./google-tag-manager-client.md) for optimal implementation.
