...
!!!example "Ampli Example"
    ...
    See example apps that use the Android [Java](https://github.com/amplitude/ampli-examples/tree/main/android/java/v2/AmpliApp) and [Kotlin](https://github.com/amplitude/ampli-examples/tree/main/android/kotlin/v2/AmpliApp) runtimes.
