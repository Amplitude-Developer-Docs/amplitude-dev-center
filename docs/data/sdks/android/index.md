...
!!!deprecated "Legacy SDK"
    This is a legacy SDK and will only receive bug fixes until deprecation. Upgrade to the [Android Kotlin SDK](/data/sdks/android-kotlin/) which supports plugins, SDK integrations, and more.
