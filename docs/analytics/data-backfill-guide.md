...
![a diagram that shows the Identify API and event data added to the user properties database and then shown in the Amplitude UI](/assets/images/data-user-property-sync-diagram.drawio.svg)
